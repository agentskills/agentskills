...
<div className="grid grid-cols-2 md:grid-cols-3 gap-4 items-center justify-items-center">
  ...
  <a href="https://commandcode.ai/" style={{textDecoration: 'none', border: 'none'}}>
    <img className="hidden dark:block object-contain" style={{width: '175px', maxWidth: '100%'}} src="/images/logos/command-code/command-code-logo-for-dark.svg" alt="Command Code" noZoom />
    <img className="block dark:hidden object-contain" style={{width: '175px', maxWidth: '100%'}} src="/images/logos/command-code/command-code-logo-for-light.svg" alt="Command Code" noZoom />
  </a>
</div>
