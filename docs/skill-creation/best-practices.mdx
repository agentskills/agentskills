...
For a more structured approach to iteration, including test cases, expectations, and grading, see [Evaluating skill output quality](/skill-creation/evaluating-skills).
